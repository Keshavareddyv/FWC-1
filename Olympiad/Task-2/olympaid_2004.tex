...
\textbf{Problem 2.}
Find all polynomials $f$ with real coefficients such that for all real numbers $a,b,c$
...
\textbf{Problem 3.}
Define a ``hook'' to be a figure made up of six unit squares as shown below in the picture,
...
\left(\dfrac{1}{t_1} + \dfrac{1}{t_2} + \cdots + \dfrac{1}{t_n}\right).$
